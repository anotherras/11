...
class MyDataset(Dataset):
    ...
    def collate_fn(batch, tokenizer):
        ...
        in_tensor = tokenizer.batch_encode_plus(in_batch, padding=True, return_attention_mask=False, return_tensors="pt", return_token_type_ids=False)
        out_tensor = tokenizer.batch_encode_plus(out_batch, padding=True, return_attention_mask=False, return_tensors="pt", return_token_type_ids=False)
...
if __name__ == "__main__":
    ...
    filepath = [
        r"/home/ljp/Project/ProteinProject/couplet-transformer/cache/Data/couplet/train/in.txt",
        r"/home/ljp/Project/ProteinProject/couplet-transformer/cache/Data/couplet/train/out.txt",
    ]
